 ...
 */
public class SqlInParameterDateTime extends SqlInParameter {
    ...
    public SqlInParameterDateTime(int index, String parameterDirection, Date dateTimeValue) {
        super(  );
    ...
    public SqlInParameterDateTime(int index, String parameterDirection) {
        setParameterIndex(index);
        setParameterDirection(parameterDirection);
    }
