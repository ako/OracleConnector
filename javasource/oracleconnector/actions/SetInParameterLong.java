...
public class SetInParameterLong extends CustomJavaAction<java.lang.Boolean>
{
	private java.lang.Long LongValue;

	public SetInParameterLong(IContext context, java.lang.Long LongValue)
	{
		super(context);
	...
	{
		// BEGIN USER CODE
		connector.setInParameterLong(this.LongValue);
		return true;
		// END USER CODE
	}
