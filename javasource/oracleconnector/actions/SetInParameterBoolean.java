...
public class SetInParameterBoolean extends CustomJavaAction<java.lang.Boolean>
{
	private java.lang.Boolean BooleanValue;

	public SetInParameterBoolean(IContext context, java.lang.Boolean BooleanValue)
	{
		super(context);
	...
	{
		// BEGIN USER CODE
		connector.setInParameterBoolean(this.BooleanValue);
		return true;
		// END USER CODE
	}
