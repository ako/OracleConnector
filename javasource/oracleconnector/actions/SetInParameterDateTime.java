...
public class SetInParameterDateTime extends CustomJavaAction<java.lang.Boolean>
{
	private java.util.Date DateTimeValue;

	public SetInParameterDateTime(IContext context, java.util.Date DateTimeValue)
	{
		super(context);
	...
	{
		// BEGIN USER CODE
		connector.setInParameterDateTime(this.DateTimeValue);
		return true;
		// END USER CODE
	}
