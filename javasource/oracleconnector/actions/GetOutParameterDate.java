...
public class GetOutParameterDate extends CustomJavaAction<java.util.Date>
{
	private java.lang.Long ParameterIndex;

	public GetOutParameterDate(IContext context, java.lang.Long ParameterIndex)
	{
		super(context);
	...
	{
		// BEGIN USER CODE
		return connector.getDateTimeParameterValue(this.ParameterIndex);
		// END USER CODE
	}
