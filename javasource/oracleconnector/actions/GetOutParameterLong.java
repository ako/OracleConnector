...
public class GetOutParameterLong extends CustomJavaAction<java.lang.Long>
{
	private java.lang.Long ParameterIndex;

	public GetOutParameterLong(IContext context, java.lang.Long ParameterIndex)
	{
		super(context);
	...
	{
		// BEGIN USER CODE
		return connector.getLongParameterValue(this.ParameterIndex);
		// END USER CODE
	}
